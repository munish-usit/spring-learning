...
import com.book.tracker.model.SearchResult;
import com.book.tracker.model.SearchResultBook;
...
public class SearchController {
	...
	public String getSearchResults(@RequestParam String query, Model model) {
		log.info("search request for query {}",query);
		...
		log.info("search success with results ",books.size());
		return "search";
	}
}
